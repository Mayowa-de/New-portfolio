  ...
  return (
    <main className='flex flex-col justify-center gap-4 text-center mb-12'>
        ...
        <section className='flex flex-col gap-2 mt-12 justify-center text-center' aria-label='main-section'>
            ...
            <img src={Profile} alt="Profile image" className='w-36 h-36  rounded-full border-4 border-blue-950/50' />
            </div>
        ...
        <div className='flex flex-col gap-4 w-full p-4 bg-blue-800/50 rounded-xl mt-4'>
