...
export default function Footer() {
    return (
        <footer className='flex  w-full bottom-0 justify-center text-center text-gray-400/50 flex-col'>
            ...
            <p className=' font-bold bottom-0 left-0 w-full'> &copy; All right Reserved, created by Mayortech </p>
        </footer>
    )
}
